...
description="NSLog logging back-end, plain pod install"
...
assert_file_contains pod_out.log "Installing LibComponentLogging-NSLog (1.1.1)"
...
assert_file_contains pod_out.log "Using LibComponentLogging-NSLog (1.1.1)"
