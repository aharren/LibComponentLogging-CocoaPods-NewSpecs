...
assert_file_contains configure_out.log "Creating configuration file 'Pods/BuildHeaders/RestKit/lcl_config_components.h'"
assert_file_contains configure_out.log "Creating configuration file 'Pods/BuildHeaders/RestKit/lcl_config_logger.h'"
assert_file_contains configure_out.log "Creating configuration file 'Pods/BuildHeaders/RestKit/lcl_config_extensions.h'"
assert_file_contains configure_out.log "Creating configuration file 'Pods/BuildHeaders/RestKit/LCLLogFileConfig.h'"
assert_file_contains configure_out.log "Creating configuration file 'Pods/BuildHeaders/RestKit/LCLUserDefaultsConfig.h'"
